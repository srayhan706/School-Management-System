...
public class HighSchool extends Mendatory_subject {
    public Integer science;
    public Integer religion;
    public  Integer ict;
    public Integer bgs;

    public HighSchool(Integer crud_id, String crud_name, String curd_gender, Integer b1, Integer b2, Integer e1, Integer e2, Integer m, Integer s, Integer r, Integer bg, Integer ic) {
